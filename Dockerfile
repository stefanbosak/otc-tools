...
# container as builder for preparing OTC cloud tools
FROM otc-tools-builder AS otc-tools-kpt-builder

LABEL stage="otc-tools-kpt-builder" \
      description="Debian-based container builder for preparing OTC cloud tool kpt CLI" \
      org.opencontainers.image.description="Debian-based container builder for preparing OTC cloud tool kpt CLI" \
      org.opencontainers.image.url=https://github.com/stefanbosak/otc-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/otc-tools
...
# container as builder for preparing OTC cloud tools
FROM otc-tools-builder AS otc-tools-opentofu-builder

LABEL stage="otc-tools-opentofu-builder" \
      description="Debian-based container builder for preparing OTC cloud tool OpenTofu" \
      org.opencontainers.image.description="Debian-based container builder for preparing OTC cloud tool OpenTofu" \
      org.opencontainers.image.url=https://github.com/stefanbosak/otc-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/otc-tools
...
# container as builder for preparing OTC cloud tools
FROM otc-tools-builder AS otc-tools-sofka-builder

LABEL stage="otc-tools-sofka-builder" \
      description="Debian-based container builder for preparing OTC cloud tool sofka CLI" \
      org.opencontainers.image.description="Debian-based container builder for preparing OTC cloud tool sofka CLI" \
      org.opencontainers.image.url=https://github.com/stefanbosak/otc-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/otc-tools
...
COPY --from=otc-tools-ansible-cli-builder "/usr/local/share/uv/tools" "/usr/local/share/uv/tools"
...
COPY --from=otc-tools-kpt-builder "/usr/local/bin/" "/usr/local/bin/"
...
COPY --from=otc-tools-opentofu-builder "/usr/local/bin/" "/usr/local/bin/"
COPY --from=otc-tools-otc-cli-builder "/usr/local/bin/" "/usr/local/bin/"
COPY --from=otc-tools-sofka-builder "/usr/local/bin/" "/usr/local/bin/"
