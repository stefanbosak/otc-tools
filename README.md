...
| **OTC CLI** | [`v0.0.8`](https://github.com/ysoftdevs/otc-cli/releases/tag/v0.0.8) |
...
> 🔄 Last updated: 2026-08-13T10:43:33+02:00 · [Build #60](https://github.com/stefanbosak/otc-tools/actions/runs/31720827507)
<!-- VERSION_INFO_END -->
...
OTC infrastructure is incrementally covered via [Terraform](https://developer.hashicorp.com/terraform) code, using the [`opentelekomcloud/opentelekomcloud`](https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/latest/docs) provider. The same HCL is compatible with the [OpenTofu](https://opentofu.org/) CLI included in this image — run `tofu` in place of `terraform` if preferred.
